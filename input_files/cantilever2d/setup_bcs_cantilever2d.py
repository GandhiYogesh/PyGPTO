...
compute_predefined_node_sets(FE, {0: 'MR_pt', 1: 'L_edge'})
# for an overview of this function, use: help compute_predefined_node_sets

#print( FE['node_set'] )

BR_pt = FE['node_set']['MR_pt']
...
# of prescribed displacement dofs
FE['BC']['n_pre_disp_dofs'] = disp_mat.shape[0]
