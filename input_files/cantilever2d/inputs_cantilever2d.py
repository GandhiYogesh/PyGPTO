...
# FE['mesh_input']['box_dimensions'] = np.array((10, 5))
# FE['mesh_input']['elements_per_side'] = np.array((50, 10))
...
FE['material'] = {'E': 15, 'nu': 0.3}
FE['void'] = {'Emin': 1e-6, 'nu': 0.3}
...
FE['analysis'] = {'solver': {}}
# 'direct'  # Options: 'direct' or 'iterative'
FE['analysis']['solver']['type'] = 'direct'
